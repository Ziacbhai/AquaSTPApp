...
public class WelcomeOwnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ownerexit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WelcomeOwnerActivity.this,LoginSignupActivity.class);
        ...
        oContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Global.StpList.isEmpty()) {
                    startActivity(new Intent(WelcomeOwnerActivity.this, GenerateSTPdetails.class));
                } else {
                    startActivity(new Intent(WelcomeOwnerActivity.this, SelectSTPLocationActivity.class));
                }
    ...
    private void opencamera() {
        ...
        ImagePicker.with(WelcomeOwnerActivity.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
            ...
            try {
                if (resp.getBoolean("success")) {
                    ...
                    Global.customtoast(WelcomeOwnerActivity.this, getLayoutInflater(), "Image uploaded successfully");
                    getuserdetails();
                    String userimage = Global.userImageurl + Global.sharedPreferences.getString("user_image", "");
                    Picasso.Builder builder = new Picasso.Builder(getApplication());
                    Picasso picasso = builder.build();
                    ...
                    if (resp.has("error")) {
                        ...
                        Toast.makeText(WelcomeOwnerActivity.this, errorMessage, Toast.LENGTH_SHORT).show();
                        Toast.makeText(WelcomeOwnerActivity.this, "Image upload failed", Toast.LENGTH_SHORT).show();
    ...
    private void getuserdetails() {
        ...
        RequestQueue queue = Volley.newRequestQueue(WelcomeOwnerActivity.this);
