...
public class LabTestAdapter extends RecyclerView.Adapter<LabTestAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull LabTestAdapter.Viewholder holder, int position) {
        ...
        Date date;
        try {date = inputFormat.parse(labdate);
        ...
        Date date1;
        try {date1 = inputFormat1.parse(LabRefDate);
        ...
        Date date3;
        try {date3 = inputFormat2.parse(Start_Date);
        ...
        Date date_;
        try {date_ = inputFormat_1.parse(Completion_Date);
        ...
        Date date2_;
        try {date2_ = inputFormat_2.parse(Sample_Received_Date);
